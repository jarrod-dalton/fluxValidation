...
test_that("compute_obs_risk policy vs interval behave as expected", {
  ...
  pol <- compute_obs_risk(obs, event = "E", times = c(0,1,2), start_time = 0, mode = "fixed_cohort")
  ...
  int <- compute_obs_risk(obs, event = "E", times = c(0,1,2), start_time = 0, mode = "risk_set")
